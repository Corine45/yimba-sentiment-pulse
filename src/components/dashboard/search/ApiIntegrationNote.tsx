  ...
  return (
    <div className="p-3 bg-green-50 border border-green-200 rounded-lg">
      ...
      <div className="text-xs text-green-700 space-y-1">
        ...
        <p>• Filtrage strict : seules les plateformes sélectionnées sont interrogées</p>
      </div>
      <div className="mt-2 p-2 bg-blue-50 border border-blue-200 rounded text-xs text-blue-700">
        <strong>🔍 Mode API Pure:</strong> Chaque recherche interroge exclusivement vos endpoints selon les filtres - Zéro génération de données
      </div>
    </div>
  );
};
